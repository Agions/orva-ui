...
export class TableStyles {
  ...
  static getClassName(props: {
    ...
    const baseClass = 'orva-ui-table';
    const sizeClass = `orva-ui-table--${size}`;
    const borderedClass = bordered ? 'orva-ui-table--bordered' : '';
    const stripedClass = striped ? 'orva-ui-table--striped' : '';
    const hoverableClass = hoverable ? 'orva-ui-table--hoverable' : '';
    const loadingClass = loading ? 'orva-ui-table--loading' : '';
