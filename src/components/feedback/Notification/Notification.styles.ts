...
export const notificationStyles = {
  /** 基础类名 */
  base: 'orva-ui-notification',
  /** 图标类名 */
  icon: 'orva-ui-notification-icon',
  /** 图标文本类名 */
  iconText: 'orva-ui-notification-icon-text',
  /** 内容类名 */
  content: 'orva-ui-notification-content',
  /** 标题类名 */
  title: 'orva-ui-notification-title',
  /** 文本类名 */
  text: 'orva-ui-notification-text',
  /** 关闭按钮类名 */
  close: 'orva-ui-notification-close',
  /** 关闭悬停类名 */
  closeHover: 'orva-ui-notification-close-hover',
  /** 关闭图标类名 */
  closeIcon: 'orva-ui-notification-close-icon',
  /** 动画类名 */
  animation: {
    enter: 'orva-ui-notification-enter',
    enterActive: 'orva-ui-notification-enter-active',
    exit: 'orva-ui-notification-exit',
    exitActive: 'orva-ui-notification-exit-active',
  },
} as const;
