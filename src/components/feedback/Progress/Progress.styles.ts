...
export const ProgressCSSVariables = {
  primaryColor: '--orva-ui-progress-primary-color',
  successColor: '--orva-ui-progress-success-color',
  errorColor: '--orva-ui-progress-error-color',
  warningColor: '--orva-ui-progress-warning-color',
  backgroundColor: '--orva-ui-progress-background-color',
  borderRadius: '--orva-ui-progress-border-radius',
  strokeWidth: '--orva-ui-progress-stroke-width',
};
