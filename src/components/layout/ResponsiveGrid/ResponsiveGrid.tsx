 ...
 * 根据屏幕尺寸自动调整列数和间距
 */
export const ResponsiveGrid = createComponent<ResponsiveGridProps>({
  name: 'ResponsiveGrid',
  render: (props, ref) => {
    const {
      children,
 ...
 * 根据屏幕尺寸自动调整占据列数
 */
export const ResponsiveGridItem = createComponent<ResponsiveGridItemProps>({
  name: 'ResponsiveGridItem',
  render: (props, ref) => {
    const {
      children,
      className = '',
