...
export class RadioStyles {
  ...
  private static getPlatformPrefix(): string {
    ...
    return `orva-ui-${platformName}-radio`;
  }
  ...
  > = {
      ...
      small: { fontSize: 24, size: 20, borderRadius: 10, padding: 6, iconSize: 12 },
      medium: { fontSize: 28, size: 24, borderRadius: 12, padding: 8, iconSize: 14 },
      large: { fontSize: 32, size: 28, borderRadius: 14, padding: 10, iconSize: 16 },
    };
  ...
  > = {
      ...
      outline: { backgroundColor: 'transparent', borderColor: '#d1d5db', borderWidth: 2 },
    };
  ...
  static getStyleConfig(): RadioStyleConfig {
    return {
      ...
      sizes: {
        ...
        small: { fontSize: 24, width: 20, height: 20 },
        medium: { fontSize: 28, width: 24, height: 24 },
        large: { fontSize: 32, width: 28, height: 28 },
      },
      statuses: {
        default: {
          backgroundColor: '#ffffff',
