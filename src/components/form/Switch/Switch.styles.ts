...
export const switchStyles = {
  ...
  getClassName: ({
    ...
    const baseClasses = [
      'orva-ui-switch',
      `orva-ui-switch--${size}`,
      `orva-ui-switch--${variant}`,
      `orva-ui-switch--${color}`,
      `orva-ui-switch--${status}`,
    ];

    if (disabled) {
      baseClasses.push('orva-ui-switch--disabled');
    }

    if (loading) {
      baseClasses.push('orva-ui-switch--loading');
    }

    if (checked) {
      baseClasses.push('orva-ui-switch--checked');
    }

    if (bordered) {
      baseClasses.push('orva-ui-switch--bordered');
    }

    if (block) {
      baseClasses.push('orva-ui-switch--block');
    }
  ...
  getTrackClassName: ({
    ...
    const baseClasses = [
      'orva-ui-switch__track',
      `orva-ui-switch__track--${size}`,
      `orva-ui-switch__track--${variant}`,
      `orva-ui-switch__track--${color}`,
      `orva-ui-switch__track--${status}`,
    ];

    if (disabled) {
      baseClasses.push('orva-ui-switch__track--disabled');
    }

    if (loading) {
      baseClasses.push('orva-ui-switch__track--loading');
    }

    if (checked) {
      baseClasses.push('orva-ui-switch__track--checked');
    }

    if (bordered) {
      baseClasses.push('orva-ui-switch__track--bordered');
    }
  ...
  getThumbClassName: ({
    ...
    const baseClasses = ['orva-ui-switch__thumb', `orva-ui-switch__thumb--${size}`];

    if (disabled) {
      baseClasses.push('orva-ui-switch__thumb--disabled');
    }

    if (loading) {
      baseClasses.push('orva-ui-switch__thumb--loading');
    }

    if (checked) {
      baseClasses.push('orva-ui-switch__thumb--checked');
    }
