import type { ToggleableProps } from '@/types/component';
import type { ReactNode, InputHTMLAttributes } from 'react';
import type { ITouchEvent } from '@tarojs/components';

/** 复选框颜色 */
export type CheckboxColor = 'default' | 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info';

/** 复选框状态 */
export type CheckboxStatus = 'unchecked' | 'checked' | 'indeterminate' | 'normal' | 'error' | 'disabled' | 'warning' | 'success';

/** 复选框尺寸 */
export type CheckboxSize = 'small' | 'medium' | 'large' | 'sm' | 'md' | 'lg' | 'xs' | 'xl';

/** 复选框变体 */
export type CheckboxVariant = 'outlined' | 'filled' | 'default';

/** 复选框组件属性接口 */
export interface CheckboxProps extends CheckboxAccessibilityProps {
  checked?: boolean;
...
export interface CheckboxStyleConfig {
  ...
  base: React.CSSProperties;
	/** 复选框尺寸样式 */
  sizes: Partial<Record<CheckboxSize, React.CSSProperties>>;
	/** 复选框状态样式 */
  statuses: Partial<Record<CheckboxStatus, React.CSSProperties>>;
	/** 复选框变体样式 */
  variants: Partial<Record<CheckboxVariant, React.CSSProperties>>;
	/** 复选框颜色样式 */
  colors: Partial<Record<CheckboxColor, React.CSSProperties>>;
	/** 复选框图标样式 */
