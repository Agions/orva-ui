...
/** 选择器状态 */
export type SelectStatus = 'default' | 'normal' | 'success' | 'warning' | 'error' | 'disabled' | 'loading';
...
export interface SelectOptionGroup {
  label?: ReactNode;
  options?: Array<{ value: string | number; label?: ReactNode; disabled?: boolean; [key: string]: any }>;
  disabled?: boolean;
  [key: string]: any;
}
