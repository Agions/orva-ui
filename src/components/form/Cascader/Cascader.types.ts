import type { BaseProps, FormItemProps } from '@/types/component';
...
/** 级联状态 */
export type CascaderStatus = 'default' | 'success' | 'warning' | 'error';
...
/** Cascader 原生属性 */
export interface CascaderNativeProps extends FormItemProps {
	/** 点击事件 */
...
/** 级联选择器属性接口 */
export interface CascaderProps extends BaseProps, Omit<CascaderNativeProps, 'onChange' | 'onFocus' | 'onBlur'> {
	/** 选项数据 */
