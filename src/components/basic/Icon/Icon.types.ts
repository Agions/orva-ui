...
/** 图标状态 */
export type IconStatus = 'default' | 'success' | 'warning' | 'error' | 'info' | 'normal' | 'active' | 'disabled' | 'loading';

/** 图标尺寸 */
export type IconSize = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl';

/** 图标主题 */
export type IconTheme = 'outlined' | 'filled' | 'rounded' | 'sharp' | 'two-tone' | 'colored';
...
/** 图标旋转角度 */
export type IconRotation = number | '90' | '180' | '270';
/** 图标源类型 */
export type IconSource = string | React.ReactNode | { uri: string } | { svg: string };
...
/** 原生图标属性 */
export type IconNativeProps = IconProps & { source?: IconSource; name?: string; family?: string; };
