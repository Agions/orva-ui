...
export const defaultTheme: ThemeConfig = {
  mode: 'light',
  colors: {
    primary: colorTokens.primary[500],      // #a855f7 紫罗兰
    secondary: colorTokens.secondary[500],  // #f97316 珊瑚橙
    ...
    textDisabled: colorTokens.text.disabled ?? '#a1a1aa',
    textInverse: colorTokens.text.inverse ?? '#ffffff',

    background: colorTokens.background.primary,
    backgroundCard: colorTokens.background.card ?? '#ffffff',
    backgroundInput: colorTokens.background.input ?? '#fafafa',
    backgroundMask: colorTokens.background.mask ?? 'rgba(0, 0, 0, 0.45)',
    backgroundDisabled: '#f1f5f9',

    border: colorTokens.border.default,
    borderLight: colorTokens.border.light,
    borderFocus: colorTokens.border.focus ?? '#a855f7',
    ...
    link: colorTokens.text.link ?? '#a855f7',
