 ...
 * 主题模式
 */
const logger = createLogger('Theme Provider');
 ...
 * @example
 * ```tsx
 * import { ThemeProvider } from 'orva-ui';
 *
 * function App() {
 *   return (
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      logger.warn('[ThemeProvider] Failed to load theme from storage:', error);
    }
  ...
  useEffect(() => {
    ...
    try {
      ...
      logger.warn('[ThemeProvider] Failed to save theme to storage:', error);
    }
