...
const logger = createLogger('App Provider');
  ...
  useEffect(() => {
    ...
    const loadPlatformInfo = async () => {
      try {
        ...
        logger.warn('[AppProvider] platform module unavailable, falling back to env detection:', error);
      }
    };
