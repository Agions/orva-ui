...
import { cn, createBEM, createNamespace, conditionalClass, uniqueClasses } from '../../utils/classnames';
...
describe('classnames', () => {
  ...
  describe('createNamespace', () => {
    it('should return namespaced component name', () => {
      const ns = createNamespace('orva-ui');
      expect(ns('button')).toBe('orva-ui-button');
    });

    it('should return namespaced component with modifier', () => {
      const ns = createNamespace('orva-ui');
      expect(ns('button', 'primary')).toBe('orva-ui-button orva-ui-button--primary');
    });

    it('should handle modifiers object', () => {
      const ns = createNamespace('orva-ui');
      expect(ns('button', { primary: true, disabled: false })).toBe('orva-ui-button orva-ui-button--primary');
    });
  });
