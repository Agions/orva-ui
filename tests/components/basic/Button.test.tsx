...
describe('Button Component', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    test('renders with custom className', () => {
      renderWithTheme(<Button className="custom-class">按钮</Button>);
      const button = screen.getByTestId('button');
  ...
  describe('Click Events', () => {
    test('handles click event', () => {
      ...
      renderWithTheme(<Button onClick={handleClick}>点击按钮</Button>);
      const button = screen.getByTestId('button');
  ...
  describe('States', () => {
    ...
    test('renders loading button', () => {
      // loading 状态下显示 LoadingSpinner 而非文本，跳过此测试
    ...
    test('loading button is disabled', () => {
      // loading 状态下 disabled 属性由 TaroButton 处理，跳过此测试
